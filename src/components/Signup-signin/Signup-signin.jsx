        ...
        <div className='signin-signup'>
          <form action='' className='sign-form sign-form__sign-in'>
            ...
            <div className='sign-form__field'>
              ...
              <input
                type='text'
                className='sign-in-form__input sign-in-form__input_userName'
                placeholder='Email'
              />
            </div>
            <div className='sign-form__field'>
              ...
              <input
                type='password'
                className='sign-in-form__input sign-in-form__input_password'
            ...
            <p className='sign-in__social-text'>
              ...
              <ul className='sign-in__social-list'>
                <li className='sign-in__social-image'>
                  <a
                    ...
                    className='sign-in__social-image_link'
                    target='_blank'
                    rel='noreferrer'
                  >
                    <img
                      src={facebookLogo}
                      alt='facebook logo'
                      className='sign-in__social-image_icon'
                    />
                  </a>
                </li>
                <li className='sign-in__social-image'>
      ...
      <div className='panels-container'>
        <div className='panels-container__panel panels-container__left-panel'>
          <div className='panels-container__content'>
            ...
            <p className='panels-container__text'>
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Commodi
              dolor ex nulla!
            </p>
            <button
              className='sign__submit panels-container__button'
              id='sign-up-btn'
              onClick={signUpMode ? handleSignInMode : handleSignUpMode}
            >
              Sign up
            </button>
          </div>
          ...
          <img
            src={rocketLogo}
            alt='rocket logo'
            className='panels-container__image'
          />
        </div>
